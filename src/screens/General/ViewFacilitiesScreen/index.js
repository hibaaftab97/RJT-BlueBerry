...
const ViewFacilitiesScreen = props => {
  const navigation = useNavigation();

  const facilities = [{
    name: 'Fresh Packing Equipment',
  ...
  {
    name: 'Can-Usa Cold Storage',
    description:"CAN-USA Cold Storage Inc. was founded in 2011 in affiliation  with R.J.T Blueberry Park Inc, the company is located in British Columbia’s Fraser Valley, near Highway 1 and only 10 minutes away from the US border by truck, which makes it an ideal transportation hub."

  },
  {
    name: 'Frozen Packing Equipment',
    description:"CAN-USA Cold Storage Inc. was founded in 2011 in affiliation  with R.J.T Blueberry Park Inc, the company is located in British Columbia’s Fraser Valley, near Highway 1 and only 10 minutes away from the US border by truck, which makes it an ideal transportation hub."
  ...
  const renderSearchHeader = () => {
    return (
      <ImageBackground
        source={generalImages.facilityBG}
        ...
        <View style={styles.rowContainer}>
          ...
          <TextWrapper style={styles.searchTextStyle}>Our Facilities</TextWrapper>
...
export default ViewFacilitiesScreen;
